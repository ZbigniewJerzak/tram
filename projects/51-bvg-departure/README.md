...
- connects to the Wi-Fi network `brinensaft`;
...
The file must contain only the password for `brinensaft`:
...
2. Connects to the Wi-Fi network `brinensaft`.
...
- whether `brinensaft` is available;
